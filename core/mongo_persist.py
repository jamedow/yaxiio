...
class MongoPersistence:
    ...
    def __init__(self, mongo_uri: str = None, db_name: str = None):
        import os
        self.uri = mongo_uri or os.environ.get("MONGO_URI", "mongodb://127.0.0.1:27017/")
        self.db_name = db_name or os.environ.get("MONGO_DATABASE", "lightingmetal")
        self._db = None
        self._connect()
    ...
    def _connect(self):
        if not HAS_MONGO:
            return
        try:
            client = pymongo.MongoClient(self.uri, serverSelectionTimeoutMS=3000)
            client.server_info()
