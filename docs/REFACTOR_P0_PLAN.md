...
### Step 1: 提取 _do_L1 (已完成测试基线) 🔜



### Step 2: 提取 _execute_subtask + _wait_for_neuron_response

### Step 3: 提取 _orchestrate_subtasks (已部分委托给 AsyncOrchestrator)

### Step 4: 提取 _cleanup_task (已委托给 ExperienceFlywheel)
